 ...
 * @author Oscar Torres
 */
public class ArchivoGraf extends javax.swing.JFrame {

    /**
     * Creates new form ArchivoGraf
     */
    public ArchivoGraf() {
        initComponents();
        Archivo ar = new Archivo("invoices.csv");
        datos1.setModel(ar);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ArchivoGraf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ArchivoGraf().setVisible(true);
            }
        });
    }
